<template>
  <div class="space-y-4">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4">
      <div>
        ...
        <p class="text-sm text-slate-500 mt-1">
          Phân bố phản ánh theo vị trí địa lý — Tỉnh Đồng Tháp
        </p>
      </div>
    ...
    <div class="flex gap-4" style="height: calc(100vh - 200px)">
      <!-- Bản đồ Leaflet -->
      <div
        class="flex-1 bg-white rounded-lg shadow-sm border border-slate-100 overflow-hidden relative"
      >
        ...
        <div ref="mapContainer" class="w-full h-full">
          ...
          >
            ...
            <p class="text-sm text-slate-400 mt-1">
              Tích hợp Leaflet.js khi gắn API thật
            </p>
            <p class="text-xs text-slate-300 mt-3">
              Tọa độ trung tâm: 10.4538°N, 105.6324°E
            </p>

            <!-- Mock bản đồ bằng grid điểm phản ánh -->
            <div class="mt-6 w-full max-w-lg px-8">
              <div
                class="relative bg-green-50 border-2 border-dashed border-green-200 rounded-xl p-6"
        ...
        <div
          class="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm rounded-lg shadow-md border border-slate-100 p-3"
        >
        ...
        <div
          class="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-lg shadow-md border border-slate-100 p-3 min-w-[160px]"
        >
      ...
      <div
        class="w-80 bg-white rounded-lg shadow-sm border border-slate-100 flex flex-col overflow-hidden flex-shrink-0"
      >
        ...
        <div class="flex-1 overflow-y-auto divide-y divide-slate-100">
          <div
            ...
            :class="
              selectedPoint?.id === point.id ? 'bg-red-50' : 'hover:bg-slate-50'
            "
          >
...
const allPoints = ref([
  {
    ...
    address: "Đường Nguyễn Huệ, TP. Cao Lãnh",
  ...
  },
  {
    ...
    title: "Rác thải đổ trộm bờ kênh",
    status: "New",
    categoryId: "cat2",
    categoryName: "Môi trường",
    address: "Kênh Nguyễn Văn Tiếp, Xã Mỹ Trà",
  ...
  },
  {
    ...
    title: "Đèn đường hư khu dân cư Phường 2",
    status: "InProgress",
    categoryId: "cat4",
    categoryName: "Điện - Nước",
    address: "Khu dân cư Phường 2, TP. Cao Lãnh",
  ...
  },
  {
    ...
    categoryId: "cat4",
    categoryName: "Điện - Nước",
    address: "Khu phố 3, Phường Mỹ Phú",
  ...
  },
  {
    ...
    title: "Tiếng ồn quán karaoke sau 22h",
    status: "Closed",
    categoryId: "cat3",
  ...
  },
  {
    ...
    categoryId: "cat2",
    categoryName: "Môi trường",
    address: "Đường Lý Thường Kiệt, Phường 3",
  ...
  {
    id: "7",
    ticketCode: "PA-20260405-001",
    title: "Ngập nước do cống tắc tại ngã tư",
    status: "New",
    categoryId: "cat1",
    categoryName: "Hạ tầng giao thông",
    address: "Ngã tư Lê Lợi - Trần Phú",
    reporterName: "Bùi Thanh Tâm",
    lat: 10.456,
    lng: 105.628,
    x: 42,
    y: 38,
  ...
  {
    id: "8",
    ticketCode: "PA-20260406-001",
    title: "Vỉa hè bị chiếm dụng bán hàng rong",
    status: "New",
    categoryId: "cat3",
    categoryName: "An ninh trật tự",
    address: "Đường Nguyễn Sinh Sắc, Phường 4",
    reporterName: "Ngô Minh Tuấn",
    lat: 10.442,
    lng: 105.645,
    x: 55,
    y: 50,
  ...
  },
  {
    ...
    title: "Rò rỉ ống nước chính đường lớn",
    status: "InProgress",
    categoryId: "cat4",
    categoryName: "Điện - Nước",
    address: "Đường Trần Hưng Đạo, TP. Cao Lãnh",
  ...
  },
  {
    ...
    title: "Hố ga mất nắp gây nguy hiểm",
    status: "New",
    categoryId: "cat1",
    categoryName: "Hạ tầng giao thông",
    address: "Đường Phạm Hữu Lầu, Phường 6",
    reporterName: "Trương Văn Đạt",
    lat: 10.438,
    lng: 105.638,
    x: 50,
    y: 58,
...
const filteredPoints = computed(() => {
  return allPoints.value.filter((p) => {
    ...
    if (filters.value.category && p.categoryId !== filters.value.category)
      return false;
    return true;
  });
});
...
const sidebarPoints = computed(() => {
  ...
  return filteredPoints.value.filter(
    (p) =>
...
const breachedCount = computed(
  () => filteredPoints.value.filter((p) => p.isSlaBreached).length,
);
